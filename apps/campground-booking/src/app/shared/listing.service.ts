...
import { IAdvertisingObjections, IAffiliations, IB2BCommSources, IByWeekMonths, ICountries, IDroppedAffiliations, IListingCounts, IListingTypes, IListStates, IParkTypes, ISectionCodes, ITerritories, IUniqueAccounts, } from '../shared/listing-counts.model';
...
export class ListingService {
    ...
    getAdvertisingObjections():Observable<IAdvertisingObjections[]> {
      return this.http.get<any>('/api/v1/refs/advertising-objections')
